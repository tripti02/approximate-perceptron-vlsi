...
def Multiplier_2(A,B, debug=False):
    ...
    result2[2] = partial_products[2][2] ^ partial_products[3][2] ^ (partial_products[2][3] & (partial_products[1][3] | partial_products[3][3]))
    result2[1] = (partial_products[3][1] & ~partial_products[2][3])|(~partial_products[3][1] & partial_products[2][3] & (partial_products[1][3] | partial_products[3][3]))
...
def Multiplier_3(A,B, debug=False):
    ...
    result3[2] = partial_products[2][2] ^ partial_products[3][2] ^ (partial_products[2][3] & (partial_products[1][3] | partial_products[3][3]))
    result3[1] = (partial_products[3][1] & ~partial_products[2][3])|(~partial_products[3][1] & partial_products[2][3] & (partial_products[1][3] | partial_products[3][3]))
...
def approximate_multiplyN1(A , B, debug=False):
